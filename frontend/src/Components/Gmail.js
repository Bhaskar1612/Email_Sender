...
import "./Gmail.css"; // Import the CSS file
...
const Gmail = () => {
  ...
  return (
    <div className="reply-to-page">
      <h2>Gmail Direct Send</h2>
      <p>
        Send emails using a your own Gmail account so that you have complete control and visibility of the email and its response.
      </p>
